...
use \Exception;
use \PDO;
use Model\Custom\NovumOverheid\Modules as ChildModules;
 ...
 * @method     ChildModulesQuery orderByTitle($order = Criteria::ASC) Order by the title column
 ...
 * @method     ChildModulesQuery groupByTitle() Group by the title column
 ...
 * @method     ChildModules findOneByTitle(string $title) Return the first ChildModules filtered by the title column
 * @method     ChildModules findOneByIcon(string $icon) Return the first ChildModules filtered by the icon column
 * @method     ChildModules findOneByName(string $name) Return the first ChildModules filtered by the name column *
 ...
 * @method     ChildModules requireOneByTitle(string $title) Return the first ChildModules filtered by the title column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildModules[]|ObjectCollection findByTitle(string $title) Return ChildModules objects filtered by the title column
...
abstract class ModulesQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Model\Custom\NovumOverheid\Base\ModulesQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'hurah', $modelName = '\\Model\\Custom\\NovumOverheid\\Modules', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, title, icon, name FROM modules WHERE id = :p0';
        try {
    ...
    public function filterByTitle($title = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ModulesTableMap::COL_TITLE, $title, $comparison);
    }
