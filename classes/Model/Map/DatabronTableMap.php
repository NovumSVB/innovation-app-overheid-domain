...
use Model\Custom\NovumOverheid\Databron;
use Model\Custom\NovumOverheid\DatabronQuery;
...
class DatabronTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.Custom.NovumOverheid.Map.DatabronTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\Custom\\NovumOverheid\\Databron';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.Custom.NovumOverheid.Databron';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Model\\Custom\\NovumOverheid\\Databron');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Model\Custom\NovumOverheid\Databron) { // it's a model object
