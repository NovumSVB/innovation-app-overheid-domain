...
abstract class OverviewController extends GenericOverviewController
{
	...
	{
		return Component_button_alignQuery::create();
	}
	...
	public function doDelete(): void
	{
		...
		if($oDataObject instanceof Component_button_align){
		    LogActivity::register("System", "component_button_align verwijderen", $oDataObject->toArray());
		    $oDataObject->delete();
		    StatusMessage::success("component_button_align verwijderd.");
		}
		else
		{
		       StatusMessage::warning("component_button_align niet gevonden.");
		}
	...
	{
		$iId = $this->get('id', null, true, 'numeric');
		$sMessage = Translate::fromCode("Weet je zeker dat je dit component_button_align item wilt verwijderen?");
