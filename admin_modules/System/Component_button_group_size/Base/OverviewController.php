...
use Model\System\LowCode\ButtonGroup\Component_button_group_size;
use Model\System\LowCode\ButtonGroup\Component_button_group_sizeQuery;
...
abstract class OverviewController extends GenericOverviewController
{
	...
	{
		return Component_button_group_sizeQuery::create();
	}
	...
	public function doDelete(): void
	{
		...
		if($oDataObject instanceof Component_button_group_size){
		    LogActivity::register("System", "component_button_group_size verwijderen", $oDataObject->toArray());
		    $oDataObject->delete();
		    StatusMessage::success("component_button_group_size verwijderd.");
		}
		else
		{
		       StatusMessage::warning("component_button_group_size niet gevonden.");
		}
	...
	{
		$iId = $this->get('id', null, true, 'numeric');
		$sMessage = Translate::fromCode("Weet je zeker dat je dit component_button_group_size item wilt verwijderen?");
