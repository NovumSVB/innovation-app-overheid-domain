...
use Model\System\LowCode\Modal\Component_modal_button_location;
use Model\System\LowCode\Modal\Component_modal_button_locationQuery;
...
abstract class OverviewController extends GenericOverviewController
{
	...
	{
		return Component_modal_button_locationQuery::create();
	}
	...
	public function doDelete(): void
	{
		...
		if($oDataObject instanceof Component_modal_button_location){
		    LogActivity::register("System", "component_modal_button_location verwijderen", $oDataObject->toArray());
		    $oDataObject->delete();
		    StatusMessage::success("component_modal_button_location verwijderd.");
		}
		else
		{
		       StatusMessage::warning("component_modal_button_location niet gevonden.");
		}
	...
	{
		$iId = $this->get('id', null, true, 'numeric');
		$sMessage = Translate::fromCode("Weet je zeker dat je dit component_modal_button_location item wilt verwijderen?");
