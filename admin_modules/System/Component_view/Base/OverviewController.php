<?php
namespace AdminModules\Custom\NovumOverheid\System\Component_view\Base;
...
use Model\System\LowCode\View\Component_view;
use Model\System\LowCode\View\Component_viewQuery;
use Propel\Runtime\ActiveQuery\ModelCriteria;

/**
 * This class is automatically generated, do not modify manually.
 * Modify AdminModules\Custom\NovumOverheid\System\Component_view instead if you need to override or add functionality.
 */
abstract class OverviewController extends GenericOverviewController
{
	...
	{
		return Component_viewQuery::create();
	}
	...
	public function doDelete(): void
	{
		...
		if($oDataObject instanceof Component_view){
		    LogActivity::register("System", "component_view verwijderen", $oDataObject->toArray());
		    $oDataObject->delete();
		    StatusMessage::success("component_view verwijderd.");
		}
		else
		{
		       StatusMessage::warning("component_view niet gevonden.");
		}
	...
	{
		$iId = $this->get('id', null, true, 'numeric');
		$sMessage = Translate::fromCode("Weet je zeker dat je dit component_view item wilt verwijderen?");
