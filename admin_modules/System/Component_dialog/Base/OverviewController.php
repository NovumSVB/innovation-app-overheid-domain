...
abstract class OverviewController extends GenericOverviewController
{
	...
	public function doDelete(): void
	{
		...
		if($oDataObject instanceof Component_dialog){
		    LogActivity::register("System", "component_dialog verwijderen", $oDataObject->toArray());
		    $oDataObject->delete();
		    StatusMessage::success("component_dialog verwijderd.");
		}
		else
		{
		       StatusMessage::warning("component_dialog niet gevonden.");
		}
	...
	{
		$iId = $this->get('id', null, true, 'numeric');
		$sMessage = Translate::fromCode("Weet je zeker dat je dit component_dialog item wilt verwijderen?");
