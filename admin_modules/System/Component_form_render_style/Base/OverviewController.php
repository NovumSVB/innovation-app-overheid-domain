...
abstract class OverviewController extends GenericOverviewController
{
	...
	public function doDelete(): void
	{
		...
		if($oDataObject instanceof Component_form_render_style){
		    LogActivity::register("System", "component_form_render_style verwijderen", $oDataObject->toArray());
		    $oDataObject->delete();
		    StatusMessage::success("component_form_render_style verwijderd.");
		}
		else
		{
		       StatusMessage::warning("component_form_render_style niet gevonden.");
		}
	...
	{
		$iId = $this->get('id', null, true, 'numeric');
		$sMessage = Translate::fromCode("Weet je zeker dat je dit component_form_render_style item wilt verwijderen?");
