...
use Model\System\LowCode\Button\Component_button_color_type;
use Model\System\LowCode\Button\Component_button_color_typeQuery;
...
abstract class OverviewController extends GenericOverviewController
{
	...
	{
		return Component_button_color_typeQuery::create();
	}
	...
	public function doDelete(): void
	{
		...
		if($oDataObject instanceof Component_button_color_type){
		    LogActivity::register("System", "component_button_color_type verwijderen", $oDataObject->toArray());
		    $oDataObject->delete();
		    StatusMessage::success("component_button_color_type verwijderd.");
		}
		else
		{
		       StatusMessage::warning("component_button_color_type niet gevonden.");
		}
	...
	{
		$iId = $this->get('id', null, true, 'numeric');
		$sMessage = Translate::fromCode("Weet je zeker dat je dit component_button_color_type item wilt verwijderen?");
