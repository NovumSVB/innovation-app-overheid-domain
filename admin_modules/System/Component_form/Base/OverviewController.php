...
abstract class OverviewController extends GenericOverviewController
{
	...
	public function doDelete(): void
	{
		...
		if($oDataObject instanceof Component_form){
		    LogActivity::register("System", "component_form verwijderen", $oDataObject->toArray());
		    $oDataObject->delete();
		    StatusMessage::success("component_form verwijderd.");
		}
		else
		{
		       StatusMessage::warning("component_form niet gevonden.");
		}
	...
	{
		$iId = $this->get('id', null, true, 'numeric');
		$sMessage = Translate::fromCode("Weet je zeker dat je dit component_form item wilt verwijderen?");
